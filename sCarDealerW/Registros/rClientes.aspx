     ...
     <div class="container">
        ...
        <div class="form-horizontal col-md-12" role="form">
            ...
            <div class="form-group row">
             ...
             <%--Nombres--%>
            <div class="form-group row">
                <label class="control-label col-sm-3" for="NombresTextBox">Nombres:</label>
             ...
             <%--Sexo--%>
            <div class="form-group row">
                <label class="control-label col-sm-3" for="SexoTextBox">Sexo:</label>
                <div class="col-sm-1 col-md-5">
            ...
            <div class="form-group row">
             ...
             <%--Direccion--%>
            <div class="form-group row">
                <label class="control-label col-sm-3" for="DireccionTextBox">Direccion:</label>
                <div class="col-sm-1 col-md-5">
            ...
            <div class="form-group row">
             ...
             <%--Celular--%>
            <div class="form-group row">
                <label class="control-label col-sm-3" for="CelularTextBox">Celular:</label>
                <div class="col-sm-1 col-md-5">
             ...
             <%--Fecha Nacimiento--%>
            <div class="form-group row">
                <label class="control-label col-sm-3" for="FechaNacimientoTextBox">Fecha Nacimiento:</label>
                <div class="col-sm-1 col-md-5">
                    <asp:TextBox ID="FechaNacimientoTextBox" class="form-control input-group" TextMode="Date" runat="server" Enabled="true" ReadOnly="False" />
                </div>
            </div>

             <%--Fecha Registro--%>
            <div class="form-group row">
                <label class="control-label col-sm-3" for="FechaRegistroTextBox">Fecha Registro:</label>
                <div class="col-sm-1 col-md-5">
