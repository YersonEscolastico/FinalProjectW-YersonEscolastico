...
namespace sCarDealerW {
    ...
    public partial class ClientesDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientesRow AddClientesRow(string Nombres, string Sexo, string Email, string Cedula, string Direccion, string Telefono, string Celular, int UsuarioId, System.DateTime Fecha, System.DateTime FechaNacimiento, System.DateTime FechaRegistro) {
...
namespace sCarDealerW.ClientesDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([Nombres], [Sexo], [Email], [Cedula], [Direccion], [Telefono], [Celular], [UsuarioId], [Fecha], [FechaNacimiento], [FechaRegistro]) VALUES (@Nombres, @Sexo, @Email, @Cedula, @Direccion, @Telefono, @Celular, @UsuarioId, @Fecha, @FechaNacimiento, @FechaRegistro)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nombres] = @Nombres, [Sexo] = @Sexo, [Email] = @Email, [Cedula] = @Cedula, [Direccion] = @Direccion, [Telefono] = @Telefono, [Celular] = @Celular, [UsuarioId] = @UsuarioId, [Fecha] = @Fecha, [FechaNacimiento] = @FechaNacimiento, [FechaRegistro] = @FechaRegistro WHERE (([ClienteId] = @Original_ClienteId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClienteId, Nombres, Sexo, Email, Cedula, Direccion, Telefono, Celular, Usu" +
                "arioId, Fecha, FechaNacimiento, FechaRegistro FROM dbo.Clientes";
        ...
        public virtual int Insert(string Nombres, string Sexo, string Email, string Cedula, string Direccion, string Telefono, string Celular, int UsuarioId, System.DateTime Fecha, System.DateTime FechaNacimiento, System.DateTime FechaRegistro) {
            if ((Nombres == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[10].Value = ((System.DateTime)(FechaRegistro));
        ...
        public virtual int Update(string Nombres, string Sexo, string Email, string Cedula, string Direccion, string Telefono, string Celular, int UsuarioId, System.DateTime Fecha, System.DateTime FechaNacimiento, System.DateTime FechaRegistro, int Original_ClienteId) {
            if ((Nombres == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(FechaRegistro));
